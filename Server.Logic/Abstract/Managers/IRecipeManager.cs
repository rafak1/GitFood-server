...
public interface IRecipeManager
{
    ...
    public Task<IManagerActionResult<RecipeOutViewModel>> GetRecipeByIdAsync(int id, string user);
    ...
    public Task<IManagerActionResult<RecipeOutViewModel[]>> GetRecipesPagedAsync(int page, int pageSize, string searchName, int[] categoryIds);
